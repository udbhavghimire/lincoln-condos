...
$mail->Host = 'mail.lincolncondo.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@lincolncondo.ca'; // SMTP username
$mail->Password = 'lincolncondo'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@lincolncondo.ca', $_POST['name']);
$mail->addAddress('milan@homebaba.ca');

$mail->addReplyTo($_POST['email']);
$mail->isHTML(true);

$mail->Subject = "Lincoln Tower Condos Calgary - Landing Page Inquiry";
$message = '<html>
